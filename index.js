// Challenge 2:
// Remplace le paramètre "regular" par ton paramètre favori.

// paramètres: space, scary, military, romantic, cowboy, fantasy, superhero
choisirFilmFavori("fantasy")

// paramètres: watermelon, tomato, banana, orange, avocado, blueberry
choisirFruitFavori("blueberry")

// paramètres: light, dark
choisirModeFavori("dark")

// paramètres: sharp, soft, round
choisirBordureFavorite("soft")



////////////////////////////////////
// IGNORE LE CODE JAVA SCRIPT CI-DESSOUS/
////////////////////////////////////
...
function choisirBordureFavorite(style) {
    setProp("--image", "var(--" + style + ")");
}

function choisirFilmFavori(font) {
    if (font) {
        setProp("--font", "var(--" + font + ")");    
    }
}

function choisirModeFavori(mode) {
    if (mode === "light" || !mode) {
...
function choisirFruitFavori(theme) {
    if (theme === "pastel") {
